...
def create_task_tool(
    ...
    """Create a task. category must be: deep_work, short_task, or maintenance. day_date defaults to today (YYYY-MM-DD)."""
    return create_task(title, category, day_date, description)
